...
if any('ui/tui' in arg for arg in sys.argv):
    try:
        from tests.ui.tui.test_helpers import (
            MockWidget, MockContainer, MockListView, MockListItem,
            MockLabel, MockButton, MockRichLog, MockMessage
        )
...
def create_textual_mocks():
    ...
    class ReactiveMock:
        def __call__(self, *args, **kwargs):
            return property(lambda self: args[0] if args else None, lambda self, value: None)
