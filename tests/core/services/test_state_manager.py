...
class TestStateManagerBasics:
    ...
    async def test_update_state_invalid_field(
        ...
        with pytest.raises(InvalidStateError, match="Invalid state fields: invalid_field"):
...
class TestAIModelSelection:
    ...
    async def test_set_valid_ai_models(
        self,
        state_manager: StateManagerImpl
    ) -> None:
    ...
    async def test_set_invalid_ai_model(
        self,
        state_manager: StateManagerImpl
    ) -> None:
...
class TestStatePersistence:
    ...
    async def test_state_persisted_to_file(
        self,
        persistent_state_manager: StateManagerImpl,
        temp_state_file: Path
    ) -> None:
