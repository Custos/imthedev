...
class TestProjectRepository:
    ...
    @pytest.mark.asyncio
    async def test_create_project(self, temp_db, temp_project_dir):
    ...
    @pytest.mark.asyncio
    async def test_create_project_with_settings(self, temp_db, temp_project_dir):
    ...
    @pytest.mark.asyncio
    async def test_create_project_invalid_path(self, temp_db):
    ...
    @pytest.mark.asyncio
    async def test_create_project_duplicate_path(self, temp_db, temp_project_dir):
    ...
    @pytest.mark.asyncio
    async def test_get_project(self, temp_db, temp_project_dir):
    ...
    @pytest.mark.asyncio
    async def test_get_project_not_found(self, temp_db):
    ...
    @pytest.mark.asyncio
    async def test_list_projects(self, temp_db, temp_project_dir):
    ...
    @pytest.mark.asyncio
    async def test_update_project(self, temp_db, temp_project_dir):
    ...
    @pytest.mark.asyncio
    async def test_update_project_not_found(self, temp_db, temp_project_dir):
    ...
    @pytest.mark.asyncio
    async def test_delete_project(self, temp_db, temp_project_dir):
    ...
    @pytest.mark.asyncio
    async def test_delete_project_not_found(self, temp_db):
    ...
    @pytest.mark.asyncio
    async def test_current_project_management(self, temp_db, temp_project_dir):
    ...
    @pytest.mark.asyncio
    async def test_set_current_project_not_found(self, temp_db):
    ...
    @pytest.mark.asyncio
    async def test_delete_current_project_clears_cache(self, temp_db, temp_project_dir):
