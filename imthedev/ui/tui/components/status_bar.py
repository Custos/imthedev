...
class StatusBar(Widget):
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self._project_label: Static | None = None
        self._autopilot_label: Static | None = None
        self._model_label: Static | None = None
        self._connection_label: Static | None = None
    ...
    def set_status_message(self, message: str, message_type: str = "info") -> None:
        ...
        self._status_label.remove_class(
