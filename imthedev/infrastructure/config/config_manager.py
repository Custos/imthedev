...
class AppConfig:
    ...
    def validate(self) -> List[str]:
        ...
        if self.ai.default_model not in ["claude", "claude-instant", "gpt-4", "gpt-3.5-turbo"]:
...
class ConfigManager:
    ...
    def _load_from_environment(self, base_config: AppConfig) -> AppConfig:
        ...
        env_mappings = {
            ...
            'IMTHEDEV_STORAGE_MAX_CONTEXT_HISTORY': ('storage', 'max_context_history', int),
            ...
            # Security settings
            'IMTHEDEV_SECURITY_REQUIRE_APPROVAL': ('security', 'require_approval', bool),
    ...
    def _update_config_section(self, config_section: object, toml_section: Dict) -> None:
    ...
    def _apply_env_setting(self, config: AppConfig, mapping: tuple, value: str) -> None:
